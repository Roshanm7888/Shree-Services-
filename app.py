...
st.write("Tally-style Party Master & Direct PDF Download ke sath apna invoice generate karein.")
...
if submitted:
    ...
    st.success("PDF Invoice successfully generated!")
    st.download_button(
        label="📥 Click Here to Download PDF Invoice",
        data=pdf_bytes,
